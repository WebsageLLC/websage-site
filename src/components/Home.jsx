                ...
                <div className='content-center grid grid-cols-1 mx-auto flex flex-col justify-center h-full'>
                    ...
                    <div className='flex flex-row'>
                        <Link to="about" smooth={true} duration={500}>
                            <button className='text-[#05386b] border-[#05386b] group border-2 px-6 py-3 mr-5 my-2 flex items-center hover:text-white hover:bg-[#05386b] hover:border-[#05386b]'>About Us
                        ...
                        <Link to="work" smooth={true} duration={500}>
                            <button className='text-[#05386b] border-[#05386b] group border-2 px-6 py-3 my-2 flex items-center hover:text-white hover:bg-[#05386b] hover:border-[#05386b]'>View Work
                                <span className='group-hover:rotate-90 duration-300'>
                                    <HiArrowNarrowRight className='ml-3' />
                                </span>
                            </button>

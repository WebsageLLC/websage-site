    ...
    return (
        <div name='home' className='w-full h-screen bg-[#5cdb95]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <p className='text-xl text-[#edf5e1] py-4 max-w-[700px] [text-shadow:_0_2px_0_rgb(0_0_0_/_40%)]'>Whether you need a simple page or a full site, we're here to help!</p>

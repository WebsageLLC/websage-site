    ...
    return (
        ...
        <div name='about' className='w-full h-[140rem] bg-gray-800 text-gray-300'>
            ...
            <div className='flex flex-col p-4 justify-center items-center w-full h-full'>
                <div className='max-w-[1000px] mt-4 pt-4 w-full grid grid-cols-2 gap-8'>
                    <div className='sm:text-left p-4 pb-8  py-2'>
                ...
                <div className='max-w-[1000px] w-full grid sm:grid-cols-1 gap-8 px-4 py-6'>
                    <div className='sm:text-right text-4xl font-bold'>
                        <img className='shadow-lg shadow-[#040c16] hover:scale-110 duration-500 w-40 h-49 mx-auto border-4 border-[#5cdb95]' src={Jessica} alt='Camelia'></img>
                    </div>
                    <div>
                        <p className='text-2xl font-bold inline border-b-4 border-[#5cdb95]'>Jessica Ortega</p>
                        <p className='py-6 font-bold text-[#edf5e1]'>Full Stack Bootcamp graduate with experience in Web Design. Knowledge and experience in Graphic and Interior Design. I'm capable of working remotely and under pressure with the ability to develop projects starting from the concept and branding, all the way through the implementation of them.</p>
                    </div>
                </div>

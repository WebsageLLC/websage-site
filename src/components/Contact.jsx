...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-[50rem] bg-[#8ee4af] flex justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/4f2c8f41-f9b6-4cc0-ac1b-9e93a09b3313" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          ...
          <p className='text-[#05386b] py-4 font-bold'> Submit the form below to get in touch!</p>
        </div>
        ...
        <button className='text-[#05386b] border-2 border-[#05386b] hover:bg-[#05386b] hover:border-[#77DD77] hover:text-[#edf5e1] px-4 py-3 my-8 mx-auto flex items-center'>Let's Connect</button>
      </form>
